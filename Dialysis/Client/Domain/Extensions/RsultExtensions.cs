...
namespace Dialysis.Client.Domain.Extensions
{
    internal static class ResultExtensions
    {
        internal static async Task<IRetResult<T>> ToResult<T>(this HttpResponseMessage response)
        {
            try
            {
        ...
        internal static async Task<IRetResult> ToResult(this HttpResponseMessage response)
        {
            var responseAsString = await response.Content.ReadAsStringAsync();
